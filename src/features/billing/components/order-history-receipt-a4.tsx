...
interface OrderHistoryReceiptA4Props {
  order: any
}

export const OrderHistoryReceiptA4 = forwardRef<
  HTMLDivElement,
  OrderHistoryReceiptA4Props
>(({ order }, ref) => {
  ...
  const styles = {
    // ... copy all styles from receipt-a4.tsx ...
    receipt: {
      width: '210mm',
      minHeight: '297mm',
    ...
    <div ref={ref} style={styles.receipt}>
      <div style={styles.header}>
        ...
        Avanthi Institute of Engineering and Technology, Narsipatnam Road, Makavarapalem, Andhra Pradesh 531113
          <br />
          Contact No: 9876543210, 9123456780
          <br />
        </div>
      </div>
        ...
        <div style={styles.buyerContent}>
          <div style={styles.buyerInfo}>
            <div style={styles.buyerName}>
              {customerDetails?.customerName || 'Walk-in Customer'}
            </div>
            <div style={{ marginTop: '5px', fontSize: '12px' }}>
              <div>
                Mobile: {customerDetails?.customerMobile || 'Not Provided'}
              </div>
      ...
      <table style={styles.taxTable}>
        <tbody>
          ...
          <tr>
            ...
            <td style={styles.cell}>₹{(cgstAmount + sgstAmount).toFixed(2)}</td>
            <td style={styles.cell}>
              {(Math.round(amountAfterDiscount) - amountAfterDiscount).toFixed(
                2
              )}
            </td>
          </tr>
      ...
      <div style={styles.bottomSection}>
        <div style={styles.amountWords}>
          Amount In Words: INR {numberToWords(Math.round(amountAfterDiscount))}{' '}
          Only.
        </div>
...
OrderHistoryReceiptA4.displayName = 'OrderHistoryReceiptA4'
